...
export const SUPABASE_USERS_TABLE = process.env.SUPABASE_USERS_TABLE as string;
export const SUPABASE_FUNCTIONS_TABLE = process.env
  .SUPABASE_FUNCTIONS_TABLE as string;
export const SUPABASE_TIME_ENTRIES_TABLE = process.env
